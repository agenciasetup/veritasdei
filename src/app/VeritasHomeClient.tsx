...
/**
 * Home do Veritas Dei full (não-educa).
 *
 *   - Não-autenticado  → renderiza LandingPage
 *   - Em onboarding    → redireciona para /onboarding
 *   - Autenticado      → redireciona para /rezar
 *
 * Renderizado por src/app/page.tsx só quando o produto detectado pelo
 * middleware é `veritas-dei`. Pro subdomínio educa.*, page.tsx renderiza
 * a sales page direto.
 */
export default function VeritasHomeClient() {
