      ...
      {plans.map(plan => (
        ...
        >
          ...
          <button
            ...
            className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs"
            style={{
                ...
                .map(price => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <label className="flex items-center gap-2 text-xs" style={{ color: '#A8A096', fontFamily: 'Poppins, sans-serif' }}>
                        <input
                          type="checkbox"
                          checked={price.ativo}
                          onChange={e =>
