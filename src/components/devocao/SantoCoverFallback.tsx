...
interface SantoCoverFallbackProps {
  ...
  fullName?: boolean
  /**
   * Quando `silent`, o componente renderiza apenas o gradient/ornamento
   * de fundo — sem repetir o nome/invocação. Usado em contextos onde o
   * título do santo já aparece por cima no layout (hero da página /santos/[slug]).
   */
  silent?: boolean
}
