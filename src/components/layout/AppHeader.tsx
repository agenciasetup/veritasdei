...
const ROUTE_TITLES: Array<{ prefix: string; title: string }> = [
  ...
  { prefix: '/dogmas', title: 'Dogmas' },
  { prefix: '/sacramentos', title: 'Sacramentos' },
  ...
  { prefix: '/mandamentos', title: 'Mandamentos' },
  { prefix: '/preceitos', title: 'Preceitos' },
  { prefix: '/virtudes-pecados', title: 'Virtudes' },
  { prefix: '/obras-misericordia', title: 'Misericórdia' },
