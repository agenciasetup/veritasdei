...
import PreceitoCard from './components/PreceitoCard'
  ...
  return (
    <div className="flex flex-col min-h-screen relative">
      ...
      <section className="relative z-10 text-center px-4 pt-4 pb-8">
        ...
        >
          Os mandamentos da Igreja indicam o mínimo indispensável de oração e esforço moral para o crescimento no amor de Deus e do próximo.
        </p>
      ...
      <footer className="relative z-10 py-6 text-center">
        ...
        >
          Veritas Dei — Fonte: Catecismo da Igreja Católica §2041-2043
        </p>
      </footer>
    </div>
  )
